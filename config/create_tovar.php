...
if (!empty($_FILES['file']['name'])) {
    ...
    mysqli_query($connect, "INSERT INTO `menu_1` (`idMenu`, `Name`, `Price`, `Description`, `Sostav`, `Image`, `Category`) VALUES (NULL, '$Name', '$Price', '$Description', 'dfs', '$file_id', '$id_category') ");
    ...
    mysqli_query($connect, "INSERT INTO menu_1 (Name, Price, Description, Sostav, Category) VALUES ('$Name', '$Price', '$Description', 'fds', '$id_category')");
}
