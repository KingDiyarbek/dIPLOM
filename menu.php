...
$id = $_GET['id'];
$result_pizza = mysqli_query($connect, query:"SELECT * FROM `menu` WHERE `Category_idcategory`= '$id'");
...
<div class="menu">
    ...
    <div class="menu_card">
        <div class="container_1">
            ...
            <div class="button-wrapper"> 
                <button class="btn outline">450р</button>
                <button class="btn fill">Выбрат</button>
            </div>
        </div>
    </div>
    ...
    <div class="menu_card">
        <div class="container_1">
            ...
            <div class="button-wrapper"> 
                <button class="btn outline">450р</button>
                <button class="btn fill">ВыбратВыбрать</button>
            </div>
        </div>
    </div>
...
<section class="section">
    <div class="container">
        <div class="section_header">
            <h3 class="section_title">Шаурма</h3>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container">
        <div class="section_header">
            <h3 class="section_title">Роллы</h3>
        </div>
    </div>
</section>
